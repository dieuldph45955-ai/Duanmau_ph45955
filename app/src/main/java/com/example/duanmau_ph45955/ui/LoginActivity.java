...
public class LoginActivity extends AppCompatActivity {
    ...
    private void checkDangNhap() {
        ...
        if (nhanVien != null && password.equals(nhanVien.getMatKhau())) {
            ...
            // ... bên trong hàm checkDangNhap ...
            Intent intent = new Intent(LoginActivity.this, MainActivity.class);
            intent.putExtra("CHUC_VU", nhanVien.getChucVu());
            startActivity(intent);
            // SỬA TẠI ĐÂY: Lưu cả mã nhân viên và chức vụ vào AppContext
            AppContext.maNhanVien = maNhanVien;
            AppContext.chucVu = nhanVien.getChucVu(); // Thêm dòng này
    ...
    public void taoDuLieuKhachHang() {
        ...
        db.themKhachHang(new KhachHang("KH001", "Nặc danh", "", "", ""));
